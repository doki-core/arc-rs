...
// Hash of the grammar file: F902F635EA358822F1BE5DBCAAF0BBC2121176BDA0AAB7ED909A20F414A67348
...
mod peginator_generated {
    ...
    mod TableNode_impl {
        ...
        pub fn parse<'a>(
            ...
            let ParseOk { result: hint, state } = parse_Whitespace(state, tracer, cache)
    ...
    mod StringNode_impl {
        ...
        pub fn rule_parser<'a>(
            ...
            let result = parse(state, tracer, cache)?.map(|r| super::StringNode { hint: r });
            Ok(result)
        }
    }
    #[inline]
