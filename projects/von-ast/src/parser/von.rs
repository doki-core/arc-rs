...
mod peginator_generated {
                ...
                loop {
                    match parse_Whitespace(state.clone(), tracer, cache)
                        .and_then(|ParseOk { state, .. }| {
                            parse_VosStatementNode(state, tracer, cache)
                        })
    ...
    pub(super) fn parse_VosParser<'a>(
        ...
        tracer.run_traced("VosParser", state, |state, tracer| {
            VosParser_impl::rule_parser(state, tracer, cache)
        })
    }
            ...
            ChoiceHelper::new(state)
                .choice(|state| {
                    parse_Whitespace(state, tracer, cache)
                        .and_then(|ParseOk { state, .. }| {
                            parse_TableDeclareNode(state, tracer, cache)
                        })
                ...
                .choice(|state| {
                    parse_Whitespace(state, tracer, cache)
                        .and_then(|ParseOk { state, .. }| {
                            parse_StructDeclareNode(state, tracer, cache)
                        })
                ...
                .choice(|state| {
                    parse_Whitespace(state, tracer, cache)
                        .and_then(|ParseOk { state, .. }| {
                            parse_ObjectStatementNode(state, tracer, cache)
                        })
                ...
                .choice(|state| {
                    parse_Whitespace(state, tracer, cache)
                        .and_then(|ParseOk { state, .. }| {
                            parse_UnionStatementNode(state, tracer, cache)
                        })
    ...
    pub(super) fn parse_VosStatementNode<'a>(
        ...
        tracer.run_traced("VosStatementNode", state, |state, tracer| {
            VosStatementNode_impl::rule_parser(state, tracer, cache)
        })
    }
    mod TableDeclareNode_impl {
        ...
        mod part_3 {
            ...
            pub fn parse<'a>(
                ...
                loop {
                    match parse_Whitespace(state.clone(), tracer, cache)
                        .and_then(|ParseOk { state, .. }| {
                            parse_DeclareBodyNode(state, tracer, cache)
                        })
                        .map_inner(|result| vec![result])
                    {
                        Ok(ParseOk {
        ...
        pub fn rule_parser<'a>(
            ...
            let result = parse(state.clone(), tracer, cache)?.map_with_state(|r, new_state| {
                super::TableDeclareNode {
                    id: r.id,
                    body: r.body,
    ...
    pub(super) fn parse_TableDeclareNode<'a>(
        ...
        tracer.run_traced("TableDeclareNode", state, |state, tracer| {
            TableDeclareNode_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_TableDeclare<'a>(
        ...
        tracer.run_traced("TableDeclare", state, |state, tracer| {
            TableDeclare_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_StructDeclareNode<'a>(
        ...
        tracer.run_traced("StructDeclareNode", state, |state, tracer| {
            StructDeclareNode_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_StructDeclare<'a>(
        ...
        tracer.run_traced("StructDeclare", state, |state, tracer| {
            StructDeclare_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_DefineDeclare<'a>(
        ...
        tracer.run_traced("DefineDeclare", state, |state, tracer| {
            DefineDeclare_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_UnionStatementNode<'a>(
        ...
        tracer.run_traced("UnionStatementNode", state, |state, tracer| {
            UnionStatementNode_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_UnionDeclare<'a>(
        ...
        tracer.run_traced("UnionDeclare", state, |state, tracer| {
            UnionDeclare_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_ObjectDeclare<'a>(
        ...
        tracer.run_traced("ObjectDeclare", state, |state, tracer| {
            ObjectDeclare_impl::rule_parser(state, tracer, cache)
        })
    }
        ...
        pub fn parse<'a>(
            ...
            ChoiceHelper::new(state)
                .choice(|state| {
                    parse_Whitespace(state, tracer, cache)
                        .and_then(|ParseOk { state, .. }| {
                            parse_ConstraintStatementNode(state, tracer, cache)
                        })
                ...
                .choice(|state| {
                    parse_Whitespace(state, tracer, cache)
                        .and_then(|ParseOk { state, .. }| {
                            parse_FieldStatementNode(state, tracer, cache)
                        })
    ...
    pub(super) fn parse_DeclareBodyNode<'a>(
        ...
        tracer.run_traced("DeclareBodyNode", state, |state, tracer| {
            DeclareBodyNode_impl::rule_parser(state, tracer, cache)
        })
    }
    mod UnionBodyNode_impl {
        ...
        pub fn rule_parser<'a>(
            ...
            let result =
                parse(state, tracer, cache)?.map(|r| super::UnionBodyNode { id: r.id, n: r.n });
            Ok(result)
        }
    }
    #[inline]
    pub(super) fn parse_UnionBodyNode<'a>(
        ...
        tracer.run_traced("UnionBodyNode", state, |state, tracer| {
            UnionBodyNode_impl::rule_parser(state, tracer, cache)
        })
    }
    mod FieldStatementNode_impl {
        ...
        pub fn parse<'a>(
            ...
            let ParseOk { result: key, state } = parse_Whitespace(state, tracer, cache)
            ...
            Ok(ParseOk {
                result: Parsed { key, r#type, value },
                state,
            })
        }
        pub struct Parsed {
    ...
    pub(super) fn parse_FieldStatementNode<'a>(
        ...
        tracer.run_traced("FieldStatementNode", state, |state, tracer| {
            FieldStatementNode_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_TypeValueNode<'a>(
        ...
        tracer.run_traced("TypeValueNode", state, |state, tracer| {
            TypeValueNode_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_GenericNode<'a>(
        ...
        tracer.run_traced("GenericNode", state, |state, tracer| {
            GenericNode_impl::rule_parser(state, tracer, cache)
        })
    }
    mod GenericNum1_impl {
        ...
        pub fn rule_parser<'a>(
            ...
            let result = parse(state, tracer, cache)?.map(|r| super::GenericNum1 {
                token: r.token,
                num: r.num,
            });
            Ok(result)
    ...
    pub(super) fn parse_GenericNum1<'a>(
        ...
        tracer.run_traced("GenericNum1", state, |state, tracer| {
            GenericNum1_impl::rule_parser(state, tracer, cache)
        })
    }
    mod GenericNum2_impl {
        ...
        pub fn rule_parser<'a>(
            ...
            let result = parse(state, tracer, cache)?.map(|r| super::GenericNum2 {
                num1: r.num1,
                token: r.token,
                num2: r.num2,
            });
    ...
    pub(super) fn parse_GenericNum2<'a>(
        ...
        tracer.run_traced("GenericNum2", state, |state, tracer| {
            GenericNum2_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_GenericNum3<'a>(
        ...
        tracer.run_traced("GenericNum3", state, |state, tracer| {
            GenericNum3_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_GenericNum1Token<'a>(
        ...
        tracer.run_traced("GenericNum1Token", state, |state, tracer| {
            GenericNum1Token_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_GenericNum2Token<'a>(
        ...
        tracer.run_traced("GenericNum2Token", state, |state, tracer| {
            GenericNum2Token_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_KeyNode<'a>(
        ...
        tracer.run_traced("KeyNode", state, |state, tracer| {
            KeyNode_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_ValueNode<'a>(
        ...
        tracer.run_traced("ValueNode", state, |state, tracer| {
            ValueNode_impl::rule_parser(state, tracer, cache)
        })
    }
    mod DictNode_impl {
        use super::*;
    ...
    pub(super) fn parse_DictNode<'a>(
        ...
        tracer.run_traced("DictNode", state, |state, tracer| {
            DictNode_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_DictItem<'a>(
        ...
        tracer.run_traced("DictItem", state, |state, tracer| {
            DictItem_impl::rule_parser(state, tracer, cache)
        })
    }
    mod KeyValueNode_impl {
        ...
        pub fn rule_parser<'a>(
            ...
            let result = parse(state, tracer, cache)?.map(|r| super::KeyValueNode {
                key: r.key,
                value: r.value,
            });
            Ok(result)
    ...
    pub(super) fn parse_KeyValueNode<'a>(
        ...
        tracer.run_traced("KeyValueNode", state, |state, tracer| {
            KeyValueNode_impl::rule_parser(state, tracer, cache)
        })
    }
    mod ListNode_impl {
        use super::*;
    ...
    pub(super) fn parse_ListNode<'a>(
        ...
        tracer.run_traced("ListNode", state, |state, tracer| {
            ListNode_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_ListItem<'a>(
        ...
        tracer.run_traced("ListItem", state, |state, tracer| {
            ListItem_impl::rule_parser(state, tracer, cache)
        })
    }
    mod NumNode_impl {
        use super::*;
    ...
    pub(super) fn parse_NumNode<'a>(
        ...
        tracer.run_traced("NumNode", state, |state, tracer| {
            NumNode_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_ModifierNode<'a>(
        ...
        tracer.run_traced("ModifierNode", state, |state, tracer| {
            ModifierNode_impl::rule_parser(state, tracer, cache)
        })
    }
    ...
    pub(super) fn parse_NamespaceNode<'a>(
        ...
        tracer.run_traced("NamespaceNode", state, |state, tracer| {
            NamespaceNode_impl::rule_parser(state, tracer, cache)
        })
    }
