// This file was generated by Peginator v0.6.0 built at 1670311554
// CRC-32/ISO-HDLC of the grammar file: 65fc2447
...
mod peginator_generated {
    ...
    pub(super) fn parse_VomlParser<'a, TT: ParseTracer>(
        ...
        let result = {
            let result = VomlParser_impl::parse(state, global)?.map(|r| super::VomlParser { value: r });
            Ok(result)
        };
